...
public:
   ...
   void init(GLuint pid, GLuint _vao){
      ...
      // buscar position en shader de figuras _pid
      ...
      // nb_normals*sizeof(GLfloat)
      // buscar positon en shader de normales _pid
      ...
      // texture coord definition, para no usar muchas hojas en uv y dar apariencia realistica
      const GLfloat vtexcoord[] = { 0.0f, 1.0f, // coord horizontal y vertical
                                    1.0f, 1.0f,
                                    0.5f, 0.0f};
      ...
      // vao posicion del sol
      GLuint vtexcoord_id = glGetAttribLocation( _pid, "uv");
      glEnableVertexAttribArray(vtexcoord_id);
      // el segundo argumento es el numero de coordenadas
