...
public:
   ...
   virtual void load(){
      ...
      // ileaves se construye con su shader y su vao
      ileaves.init(_pid_ileaves, _vao_ileaves); 

      Trunk trunk;
      glGenVertexArrays(1, &_vao_trunk);
      // trunk se construye con su shader y su vao
   ...
   void draw_trunks(){
      ...
      glUniform3fv( glGetUniformLocation(_vao_trunk, "camera_position"), 1, camera_position);
      glUniform3fv( glGetUniformLocation(_pid_trunk, "view_pos"), 1, camera_position);
      glUniform3fv( glGetUniformLocation(_pid_trunk, "sun_col"), 1, sun_col);
   ...
   void move_leaves(float time_delta){
      ...
      if(wind_offset[0] > 50.0f){
         wind_offset[0] = 0;
      }

      wind_offset[1] += time_delta/8;
      if(wind_offset[1] > 50.0f){
         wind_offset[1] = 0;
      }
   }
   ...
   void draw_ileaves(){
      ...
      glUniform3fv( glGetUniformLocation(_pid_ileaves, "view_pos"), 1, camera_position);
      glUniform3fv( glGetUniformLocation(_vao_ileaves, "camera_position"), 1, camera_position);
      glUniform3fv( glGetUniformLocation(_pid_ileaves, "sun_col"), 1, sun_col);
      glUniform3fv( glGetUniformLocation(_pid_ileaves, "light_position"), 1, this->light_position);
